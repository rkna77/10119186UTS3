...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (view.getId() == R.id.phone) {
                    String phoneNumber = "082120400309";
        ...
        Email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (view.getId() == R.id.email) {
                    ...
                    intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"rikanuradila575@gmail.com"});
                    intent.putExtra(Intent.EXTRA_SUBJECT, "Email dari Rika APPS");
        ...
        Instagram.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Uri uri = Uri.parse("http://instagram.com/_u/rikaaadila");
                ...
                try {
                    ...
                    startActivity(new Intent(Intent.ACTION_VIEW,
                            Uri.parse("http://instagram.com/rikaaadila")));
                }
            }
        });
        ...
        Maps.setOnClickListener(view -> {
            ...
            map.setData(Uri.parse("https://goo.gl/maps/ByrASSKamkE4Hz9m7"));
            startActivity(map);
        });
